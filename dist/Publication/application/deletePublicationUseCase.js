...
class DetelePublicationUseCase {
    ...
    delete(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const deletePu = yield this.publicRepository.deletePublication(uuid);
                return deletePu;
            }
            catch (error) {
                return null;
...
exports.DetelePublicationUseCase = DetelePublicationUseCase;
