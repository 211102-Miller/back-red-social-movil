...
class UpdateDescriptionUseCase {
    ...
    updateDescription(uuid, description) {
        return __awaiter(this, void 0, void 0, function* () {
            let post = new publicationValidation_1.ValidatorUpdateDescription(uuid, description);
            ...
            try {
                const updateDescription = yield this.publicRepository.updateDescription(uuid, description);
