...
class CreateUserController {
    ...
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let { name, last_name, nick_name, phone_number, email, password, } = req.body;
                console.log(req.body);
                let registerUser = yield this.createUserUseCase.run(name, last_name, nick_name, phone_number, email, password);
