...
class UpdateUserByIdController {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let { uuid, name, last_name, nick_name, phone_number, email, } = req.body;
                let UpdateUserById = yield this.updateUserByIdUseCase.update(uuid, name, last_name, nick_name, phone_number, email);
                if (UpdateUserById) {
